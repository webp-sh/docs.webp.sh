...
If you'd like to use a customized `config.json`, you can follow [Configuration](CONFIGURATION.md) page to generate one, and mount it into the container's `/etc/config.json`, example `docker-compose.yml` as follows:
